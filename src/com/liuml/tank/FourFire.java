...
public class FourFire implements FireImp {
    ...
    public void fireImp(int x, int y, Direction direciton, TankGroup group, TankFrame tankFrame) {
        ...
        tankFrame.bulletList.add(new Bullet(bX, bY, Direction.UP, group, tankFrame));
        tankFrame.bulletList.add(new Bullet(bX, bY, Direction.DOWN, group, tankFrame));
        tankFrame.bulletList.add(new Bullet(bX, bY, Direction.LEFT, group, tankFrame));
        tankFrame.bulletList.add(new Bullet(bX, bY, Direction.RIGHT, group, tankFrame));
    }
}
